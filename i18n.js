...
(function () {
  ...
  ,
    ["Déconnexion", "تسجيل الخروج", "Log out"],
    ["Note (optionnel)", "ملاحظة (اختياري)", "Note (optional)"],
    ["Ajouter un groupe", "إضافة مجموعة", "Add Group"],
    ["Ajouter une catégorie", "إضافة تصنيف", "Add new category"],
    ["Ajouter une option", "إضافة خيار", "Add Option"],
    ["Ajouter un groupe d'options", "إضافة مجموعة خيارات", "Add Option Group"],
    ["Ajouter sans extras", "إضافة بدون إضافات", "Add without extras"],
    ["Tableau de bord admin", "لوحة تحكم المدير", "Admin Dashboard"],
    ["Afficher / Masquer le mot de passe", "إظهار / إخفاء كلمة المرور", "Show / Hide password"],
    ["Ajouter designation", "إضافة تسمية", "Add designation"],
    ["Ajouter désignation", "إضافة تسمية", "Add designation"],
    ["Ajouter une commande", "إضافة طلب", "Add an order"],
    ["Autoriser la sélection de la même option plusieurs fois ?", "السماح باختيار نفس الخيار أكثر من مرة؟", "Allow selecting same option more than once?"],
    ["Avec photo", "مع صورة", "With photo"],
    ["Caisse / Kiosk", "الصندوق / الكشك", "Cashier / Kiosk"],
    ["Annuler la modification", "إلغاء التعديل", "Cancel Edit"],
    ["Charger tout", "تحميل الكل", "Load all"],
    ["Chercher un produit...", "البحث عن منتج...", "Search a product..."],
    ["Choisir les produits qui affichent ce groupe d'options :", "اختر المنتجات التي يظهر فيها مجموعة الخيارات هذه:", "Choose which products show this option group:"],
    ["Clavier virtuel", "لوحة مفاتيح افتراضية", "Virtual keyboard"],
    ["Cliquez sur un produit pour l'ajouter", "انقر على منتج لإضافته", "Click a product to add it"],
    ["Commande en cours", "طلب قيد التنفيذ", "Order in progress"],
    ["Commandes livrées", "الطلبات المسلّمة", "Delivered orders"],
    ["Le client doit choisir une option", "يجب على الزبون اختيار خيار", "Customer must choose an option"],
    ["Supprimer la catégorie sélectionnée", "حذف التصنيف المحدد", "Delete selected category"],
    ["Gestionnaire d'extras", "مدير الإضافات", "Extras Manager"],
    ["Filtrer et analyser les commandes par période", "تصفية وتحليل الطلبات حسب الفترة", "Filter and analyze orders by period"],
    ["Filtrés par désignation/type disponibles", "مفلترة حسب التسمية/النوع المتاحة", "Filtered by available designation/type"],
    ["Nom du groupe *", "اسم المجموعة *", "Group Name *"],
    ["Historique des commandes", "سجل الطلبات", "Order history"],
    ["La sélection est-elle obligatoire ?", "هل الاختيار إلزامي؟", "Is selection mandatory?"],
    ["Le dossier à installer sur le PC de la caisse", "المجلد الذي يُثبَّت على حاسوب الصندوق", "The folder to install on the cashier PC"],
    ["Lier les groupes d'options à ce produit. Ils apparaîtront dans le menu et le kiosk quand les clients commandent.", "اربط مجموعات الخيارات بهذا المنتج. ستظهر في القائمة والكشك عند طلب الزبائن.", "Link option groups to this product. They will appear in the menu & kiosk when customers order."],
    ["Lier les produits", "ربط المنتجات", "Link Products"],
    ["Livrées / Total", "المسلّمة / المجموع", "Delivered / Total"],
    ["Lues", "مقروءة", "Read"],
    ["Gérer tous les groupes →", "إدارة كل المجموعات →", "Manage all groups →"],
    ["Maximum d'options qu'un client peut sélectionner", "أقصى عدد من الخيارات يمكن للزبون اختياره", "Maximum options a customer can select"],
    ["Mot de passe de connexion", "كلمة مرور الدخول", "Login password"],
    ["Aucun groupe pour l'instant", "لا توجد مجموعات بعد", "No groups yet"],
    ["Nom d'utilisateur", "اسم المستخدم", "Username"],
    ["Non lues", "غير مقروءة", "Unread"],
    ["Nouvelle désignation", "تسمية جديدة", "New designation"],
    ["Ouvrir dans Google Maps", "افتح في خرائط جوجل", "Open in Google Maps"],
    ["Groupes d'options", "مجموعات الخيارات", "Option Groups"],
    ["Nom de l'option *", "اسم الخيار *", "Option Name *"],
    ["Panier moyen", "متوسط السلة", "Average basket"],
    ["Par commande livrée", "لكل طلب مسلّم", "Per delivered order"],
    ["Plan des tables", "مخطط الطاولات", "Table layout"],
    ["Modificateur de prix (MAD) — 0 = gratuit", "تعديل السعر (درهم) — 0 = مجاني", "Price modifier (MAD) — 0 = free"],
    ["Priorité de réassort recommandée", "أولوية إعادة التزويد الموصى بها", "Recommended restock priority"],
    ["Produit", "منتج", "Product"],
    ["Commandes récentes", "الطلبات الأخيرة", "Recent Orders"],
    ["Rechercher un produit...", "البحث عن منتج...", "Search a product..."],
    ["Rechercher…", "بحث…", "Search…"],
    ["Retour au tableau de bord", "العودة إلى لوحة التحكم", "Back to dashboard"],
    ["Reçue depuis le menu en ligne", "مستلمة من القائمة على الإنترنت", "Received from online menu"],
    ["Enregistrer le groupe", "حفظ المجموعة", "Save Group"],
    ["Enregistrer l'option", "حفظ الخيار", "Save Option"],
    ["Sélectionner un groupe pour gérer ses options", "اختر مجموعة لإدارة خياراتها", "Select a group to manage its options"],
    ["SKU (optionnel)", "SKU (اختياري)", "SKU (optional)"],
    ["Stock, reset et historique des mouvements.", "المخزون، إعادة التعيين وسجل الحركات.", "Stock, reset and movement history."],
    ["Supprimer la réclamation ?", "حذف الشكاية؟", "Delete the complaint?"],
    ["Sélectionner une période pour afficher les commandes...", "اختر فترة لعرض الطلبات...", "Select a period to display orders..."],
    ["Taux de réussite", "نسبة النجاح", "Success rate"],
    ["Terrasse", "الطراسة", "Terrace"],
    ["Vider le panier", "إفراغ السلة", "Empty cart"],
    ["Voir notre menu", "شوف قائمتنا", "View Our Menu"],
    ["0 = unlimited", "0 = غير محدود", "0 = unlimited"],
    ["Vides:", "فارغة:", "Empty:"],
    ["| Occupées:", "| محتلة:", "| Occupied:"],
    ["ex: 2x sirop vanille", "مثال: 2x شراب الفانيليا", "e.g. 2x vanilla syrup"],
    ["Ex: Ahmed Karim", "مثال: أحمد كريم", "e.g. Ahmed Karim"],
    ["ex: Boisson Chaude, Sirop, Taille…", "مثال: مشروب ساخن، شراب، حجم…", "e.g. Hot Drink, Syrup, Size…"],
    ["ex: Café, Sucre, Lait...", "مثال: قهوة، سكر، حليب...", "e.g. Coffee, Sugar, Milk..."],
    ["ex: Espresso, Thé, Sirop Vanille…", "مثال: إسبريسو، شاي، شراب فانيليا…", "e.g. Espresso, Tea, Vanilla Syrup…"],
    ["ex: Livraison fournisseur...", "مثال: توصيل المورّد...", "e.g. Supplier delivery..."],
    ["📅 Date", "📅 التاريخ", "📅 Date"],
    ["📋 Tout afficher", "📋 عرض الكل", "📋 Show all"],
    ["📍 Address", "📍 العنوان", "📍 Address"],
    ["📞 Contact", "📞 اتصل بنا", "📞 Contact"],
    ["🕒 Hours", "🕒 ساعات العمل", "🕒 Hours"],
    ["🧑‍💼 Serveur / Caissier", "🧑‍💼 نادل / كاشير", "🧑‍💼 Waiter / Cashier"],
    ["📥 Serveur d'impression (papaya-print)", "📥 خادم الطباعة (papaya-print)", "📥 Print server (papaya-print)"],
    ["📥 Télécharger papaya-print.zip", "📥 تحميل papaya-print.zip", "📥 Download papaya-print.zip"],
    ["⏳ Chargement des produits...", "⏳ جاري تحميل المنتجات...", "⏳ Loading products..."],
    ["Fresh flavors, warm vibes, Mohammedia soul.", "نكهات طازجة، أجواء دافئة، روح المحمدية.", "Fresh flavors, warm vibes, Mohammedia soul."],
    ["Fresh. Natural. Moroccan Sunshine in Every Sip.", "طازج. طبيعي. شمس مغربية في كل رشفة.", "Fresh. Natural. Moroccan Sunshine in Every Sip."],
    ["Come experience the warmth of Mohammedia with a glass of sunshine!", "تعال عيش دفء المحمدية مع كأس من الشمس!", "Come experience the warmth of Mohammedia with a glass of sunshine!"],
    ["Located in the heart of Mohammedia", "يقع في قلب المحمدية", "Located in the heart of Mohammedia"],
    ["Monday - Sunday: 8:00 - 00:00", "الإثنين - الأحد: 8:00 - 00:00", "Monday - Sunday: 8:00 - 00:00"],
    ["Catégories - Papaya Juice", "التصنيفات - Papaya Juice", "Categories - Papaya Juice"],
    ["Commandes Live – Papaya Juice", "الطلبات المباشرة – Papaya Juice", "Live Orders – Papaya Juice"],
    ["Extras Manager — Papaya Juice", "مدير الإضافات — Papaya Juice", "Extras Manager — Papaya Juice"],
    ["Gestion du Personnel – Papaya Juice", "إدارة الموظفين – Papaya Juice", "Staff Management – Papaya Juice"],
    ["Historique Clôtures — Papaya Juice", "سجل الإغلاقات — Papaya Juice", "Closures History — Papaya Juice"],
    ["Kiosk — Papaya Juice", "الكشك — Papaya Juice", "Kiosk — Papaya Juice"],
    ["Paramètres Impression – Papaya Juice", "إعدادات الطباعة – Papaya Juice", "Print Settings – Papaya Juice"],
    ["Rapport Commandes - Papaya Juice", "تقرير الطلبات - Papaya Juice", "Orders Report - Papaya Juice"],
    ["Recettes - Papaya Juice", "الوصفات - Papaya Juice", "Recipes - Papaya Juice"],
    ["Réclamations - Papaya Juice", "الشكايات - Papaya Juice", "Complaints - Papaya Juice"],
    ["Stock - Papaya Juice", "المخزون - Papaya Juice", "Stock - Papaya Juice"],
    ["Table QR Codes - Papaya Juice", "أكواد QR للطاولات - Papaya Juice", "Table QR Codes - Papaya Juice"],
    ["Tableau de bord - Papaya Juice", "لوحة التحكم - Papaya Juice", "Dashboard - Papaya Juice"],
    ["QR Tables", "أكواد QR للطاولات", "QR Tables"]
  ,
    ["Réclamation envoyée avec succès.", "تم إرسال الشكاية بنجاح.", "Complaint sent successfully."],
    ["envoyée avec succès.", "أُرسلت بنجاح.", "sent successfully."],
    ["Filtrés par designation/type disponibles", "مفلترة حسب التسمية/النوع المتاحة", "Filtered by available designation/type"],
    ["10 QR Codes générés automatiquement", "10 أكواد QR مولّدة تلقائياً", "10 QR Codes generated automatically"],
    ["10 tables avec QR codes uniques", "10 طاولات بأكواد QR فريدة", "10 tables with unique QR codes"],
    ["10 tables configurées", "10 طاولات مُعدّة", "10 tables configured"],
    ["Contient le serveur local (localhost:3001), le service Windows et les scripts d'installation. Décompresse le ZIP, puis clic droit sur", "يحتوي على الخادم المحلي (localhost:3001)، خدمة Windows وسكريبتات التثبيت. فك ضغط ملف ZIP، ثم انقر بزر الفأرة الأيمن على", "Contains the local server (localhost:3001), the Windows service and the install scripts. Unzip the ZIP, then right-click"],
    ["→ « Exécuter en tant qu'administrateur ».", "→ «تشغيل كمسؤول».", "→ “Run as administrator”."],
    ["ex: 10", "مثال: 10", "e.g. 10"],
    ["ex: AbcD1234...", "مثال: AbcD1234...", "e.g. AbcD1234..."],
    ["ex: CAF-001", "مثال: CAF-001", "e.g. CAF-001"],
    [", your cozy corner in", "، ركنك الدافئ في", ", your cozy corner in"],
    [". Born from a passion for fresh, healthy living, we bring you the finest selection of handcrafted juices, smoothies, and café delights.", "، وُلد من شغف بالعيش الطازج والصحي، نقدّم لك أرقى تشكيلة من العصائر والسموذي ولذائذ المقهى المحضّرة يدوياً.", ". Born from a passion for fresh, healthy living, we bring you the finest selection of handcrafted juices, smoothies, and café delights."],
    ["☁️ PrintNode (Cloud)", "☁️ PrintNode (سحابي)", "☁️ PrintNode (Cloud)"]
  ];
